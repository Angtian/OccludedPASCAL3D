...
# FGL2_BGL2
wget --load-cookies /tmp/cookies.txt "https://docs.google.com/uc?export=download&confirm=$(wget --quiet --save-cookies /tmp/cookies.txt --keep-session-cookies --no-check-certificate 'https://docs.google.com/uc?export=download&id=1dNP8YE3RJ9Pzr_jQ11O6f6eYgYnq9RO' -O- | sed -rn 's/.*confirm=([0-9A-Za-z_]+).*/\1\n/p')&id=1dNP8YE3RJ9Pzr_jQ11O6f6eYgYnq9RO" -O OccludedPASCAL3D_FGL2_BGL2.zip &&
# FGL3_BGL3
